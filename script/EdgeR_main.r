...
# colours
col.mint_1   <- rgb(206/255, 34/255, 43/255, 3/4)
col.mint_2  <- rgb(206/255, 34/255, 43/255, 3/4)
col.mint_3  <- rgb(113/255, 250/255, 241/255, 3/4)
col.mvsl_1 <- rgb(209/255, 127/255, 21/255, 3/4)
col.mvsl_2 <- rgb(209/255, 127/255, 21/255, 3/4)
...
mapLength <- sum(max(mapData2$start[mapData2$chr=='aPR']), max(mapData2$start[mapData2$chr=='bHD1']), max(mapData2$start[mapData2$chr=='cHD2']), max(mapData2$start[mapData2$chr=='Chr01']), max(mapData2$start[mapData2$chr=='Chr02']), max(mapData2$start[mapData2$chr=='Chr03']), max(mapData2$start[mapData2$chr=='Chr04']), max(mapData2$start[mapData2$chr=='Chr05']), max(mapData2$start[mapData2$chr=='Chr06']), max(mapData2$start[mapData2$chr=='Chr08']), max(mapData2$start[mapData2$chr=='Chr09']), max(mapData2$start[mapData2$chr=='Chr11']), max(mapData2$start[mapData2$chr=='Chr12']), max(mapData2$start[mapData2$chr=='Chr14']), max(mapData2$start[mapData2$chr=='Chr16']))

chr_pr_end <- max(mapData2$start[mapData2$chr=='aPR'])
chr_hd1_end <- chr_pr_end + max(mapData2$start[mapData2$chr=='bHD1'])
chr_hd2_end <- chr_hd1_end + max(mapData2$start[mapData2$chr=='cHD2'])
chr_1_end <- chr_hd2_end + max(mapData2$start[mapData2$chr=='Chr01'])
...
plot(c(0, chr_16_end ), c(min(1-log(restab[[paste('FDR.',colnames(cmat)[k], sep="")]])), max(1-log(restab[[paste('FDR.',colnames(cmat)[k], sep="")]]))), axes=F, lwd=2, xlab="Chromosome", ylab="1-log(p)", type="null", col="black", main=paste(strsplit(colnames(cmat)[k], '\\.')[[1]][1], 'vs', strsplit(colnames(cmat)[k], '\\.')[[1]][2]))
axis(2, c(0, chr_16_end , 0,5,10))

points(list_nonde[[k]]$start[list_nonde[[k]]$chr=='aPR'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='aPR']), pch=20, lwd=2, type="p",col="1", main="")
points(chr_pr_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='bHD1'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='bHD1']), pch=20, lwd=2, type="p",col="1", main="")
points(chr_hd1_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='bHD2'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='bHD2']), pch=20, lwd=2, type="p",col="8", main="")
points(chr_hd2_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr01'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr01']), pch=20, lwd=2, type="p",col="1", main="")
points(chr_1_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr02'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr02']), pch=20, lwd=2, type="p",col="1", main="")
points(chr_2_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr03'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr03']), pch=20, lwd=2, type="p",col="8", main="")
points(chr_3_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr04'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr04']), pch=20, lwd=2, type="p",col="1", main="")
points(chr_4_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr05'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr05']), pch=20, lwd=2, type="p",col="8", main="")
points(chr_5_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr06'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr06']), pch=20, lwd=2, type="p",col="1", main="")
points(chr_6_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr08'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr08']), pch=20, lwd=2, type="p",col="8", main="")
#points(chr_7_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr08'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr08']), pch=20, lwd=2, type="p",col="1", main="")
points(chr_8_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr09'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr09']), pch=20, lwd=2, type="p",col="8", main="")
points(chr_9_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr11'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr11']), pch=20, lwd=2, type="p",col="1", main="")
#points(chr_10_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr11'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr11']), pch=20, lwd=2, type="p",col="8", main="")points(chr_bDH1_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr11'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr12']), pch=20, lwd=2, type="p",col="1", main="")
...
points(chr_12_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr14'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr14']), pch=20, lwd=2, type="p",col="1", main="")points(chr_bHD2_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr14'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr15']), pch=20, lwd=2, type="p",col="8", main="")
points(chr_14_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr16'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr16']), pch=20, lwd=2, type="p",col="1", main="")
#points(chr_aPR_end + list_nonde[[k]]$start[list_nonde[[k]]$chr=='Chr16'], 1-log(list_nonde[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_nonde[[k]]$chr=='Chr17']), pch=20, lwd=2, type="p",col="8", main="")
...
chromosomes<-c("aPR","bHD1","cHD2","1", "2", "3", "4", "5", "6", "8", "9", "11", "12", "14", "16")
axis (side=1, lty=0, at = chrPosition, cex.axis=.5, las=1, labels=chromosomes)

# outliers
points(list_de[[k]]$start[list_de[[k]]$chr=='aPR' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='aPR' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, cex=0.8, type="p",col=col4, main="")
points(list_de[[k]]$start[list_de[[k]]$chr=='aPR' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='aPR' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > -logFC_use]), pch=25, lwd=1, cex=0.8, type="p",col=col2, main="")
points(chr_apr_end + list_de[[k]]$start[list_de[[k]]$chr=='bHD1' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='bHD1' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p", cex=0.8, col=col4, main="")
points(chr_apr_end + list_de[[k]]$start[list_de[[k]]$chr=='bHD1' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='bHD1' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
points(chr_bHD1_end + list_de[[k]]$start[list_de[[k]]$chr=='cHD2' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='cHD2' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p", cex=0.8, col=col4, main="")
points(chr_bHD1_end + list_de[[k]]$start[list_de[[k]]$chr=='cHD2' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='cHD2' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
points(chr_cHD2_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr01' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr01' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p", cex=0.8, col=col4, main="")
points(chr_cHD2_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr01' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr01' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
...
points(chr_6_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr08' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr08' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p",col=col4, cex=0.8, main="")
points(chr_6_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr08' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr08' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
...
points(chr_9_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr11' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr11' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p",col=col4, cex=0.8, main="")
points(chr_9_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr11' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr11' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
#points(chr_10_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr12' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr12' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p", cex=0.8, col=col4, main="")
#points(chr_10_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr12' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr12' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
...
points(chr_12_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr14' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr14' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p",col=col4, cex=0.8, main="")
points(chr_12_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr14' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr14' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
points(chr_14_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr15' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr16' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] > logFC_use]), pch=24, lwd=1, type="p",col=col4, cex=0.8, main="")
points(chr_14_end + list_de[[k]]$start[list_de[[k]]$chr=='Chr15' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use], 1-log(list_de[[k]][[paste('FDR.',colnames(cmat)[k], sep="")]][list_de[[k]]$chr=='Chr16' & list_de[[k]][[paste('logFC.', colnames(cmat)[k], sep="")]] < -logFC_use]), pch=25, lwd=1, type="p",col=col2, cex=0.8, main="")
