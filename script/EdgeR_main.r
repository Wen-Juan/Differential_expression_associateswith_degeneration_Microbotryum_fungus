...
mapLength <- sum(max(mapData2$start[mapData2$chr=='MAT']), max(mapData2$start[mapData2$chr=='Auto']))

chr_1_end <- max(mapData2$start[mapData2$chr=='MAT'])
chr_2_end <- chr_1_end + max(mapData2$start[mapData2$chr=='Auto'])
