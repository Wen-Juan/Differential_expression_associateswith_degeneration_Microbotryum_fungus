...
pdf("/Users/Wen-Juan/Dropbox (Amherst College)/Amherst_postdoc/github/Haploidselection_and_dosagecompensation_in_Microbotryum/output/figures/Mvsl_a1A2_cdsratio_a1a2.pdf", width=8, height=8)
...
ggplot(stopcodon, aes(x=chr, y=cdsratio, fill=DE_status)) + 
