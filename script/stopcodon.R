...
pdf("/Users/Wen-Juan/Dropbox (Amherst College)/Amherst_postdoc/github/Haploidselection_and_dosagecompensation_in_Microbotryum/output/figures/Mvsl_a1a2_DEnonDE_protlength_8compartments.pdf", width=8, height=8)
ggplot(stopcodon_sep, aes(x=mean_exp, y=log2(protleng), fill=interaction(haploid,DE_status))) + 
...
pdf("/Users/Wen-Juan/Dropbox (Amherst College)/Amherst_postdoc/github/Haploidselection_and_dosagecompensation_in_Microbotryum/output/figures/Mvsl_a1a2sep_DEnonDE_protlength_3compartment_scatter.pdf", width=8, height=8)
ggplot(stopcodon_sep, aes(x=mean_exp, y=log2(protleng),color=interaction(haploid,DE_status))) + 
