...
annotation <- read.delim(file.path(datapath, "haploidwater_new4_annotation.txt"), sep="\t", header=TRUE, stringsAsFactors=FALSE) # BRM_annotation.txt annotation_out.txt
